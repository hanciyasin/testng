...
public class C01_SoftAssert {
    ...
    public void test01() {
        ...
        driver.findElement(By.xpath("(//input)[1]")).sendKeys("username", Keys.TAB, "password", Keys.ENTER);
        ...
        softAssert.assertEquals(seciliOption, expectedOption, "Secili option uygun degil");
